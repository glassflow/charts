...
![Version: 0.3.9](https://img.shields.io/badge/Version-0.3.9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.4.3](https://img.shields.io/badge/AppVersion-2.4.3-informational?style=flat-square)
...
|------------|------|---------|
| https://glassflow.github.io/glassflow-etl-k8s-operator | glassflow-operator | 0.6.4 |
...
| glassflow-operator.controllerManager.manager.image.tag | string | `"v1.3.2"` |  |
...
| glassflow-operator.glassflowComponents.ingestor.image.tag | string | `"v2.4.3"` |  |
| glassflow-operator.glassflowComponents.ingestor.logLevel | string | `"INFO"` |  |
| glassflow-operator.glassflowComponents.ingestor.resources.limits.cpu | string | `"1500m"` |  |
| glassflow-operator.glassflowComponents.ingestor.resources.limits.memory | string | `"1.5Gi"` |  |
| glassflow-operator.glassflowComponents.ingestor.resources.requests.cpu | string | `"1000m"` |  |
| glassflow-operator.glassflowComponents.ingestor.resources.requests.memory | string | `"1Gi"` |  |
...
| glassflow-operator.glassflowComponents.join.image.tag | string | `"v2.4.3"` |  |
| glassflow-operator.glassflowComponents.join.logLevel | string | `"INFO"` |  |
| glassflow-operator.glassflowComponents.join.resources.limits.cpu | string | `"1500m"` |  |
| glassflow-operator.glassflowComponents.join.resources.limits.memory | string | `"1.5Gi"` |  |
| glassflow-operator.glassflowComponents.join.resources.requests.cpu | string | `"1000m"` |  |
| glassflow-operator.glassflowComponents.join.resources.requests.memory | string | `"1Gi"` |  |
...
| glassflow-operator.glassflowComponents.sink.image.tag | string | `"v2.4.3"` |  |
| glassflow-operator.glassflowComponents.sink.logLevel | string | `"INFO"` |  |
| glassflow-operator.glassflowComponents.sink.resources.limits.cpu | string | `"1500m"` |  |
